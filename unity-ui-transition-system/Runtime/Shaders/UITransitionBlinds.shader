Shader "Custom/UI/Transition/Blinds"
{
    Properties
    {
        ...
        _StripeCount("Stripe Count", Range(4,40)) = 12
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                float stripeUv = frac(IN.uv.y * _StripeCount);
                float cutoff = _Progress * (1.0 + _Softness) - _Softness;
                float alphaMask = smoothstep(cutoff, cutoff + _Softness, stripeUv);
